...
const views = {
  ...
  follow: document.getElementById("view-follow"),
};
...
function startApp() {
  ...
  const renderers = {
    ...
    follow: follow.render,
  };

  initNav({
    viewIds: new Set(["search", "lyrics-assist", "arrangement", "image-crop", "qr-code", "spellcheck", "live", "scripture", "library-sync", "follow"]),
    onNavigate: (id) => {
